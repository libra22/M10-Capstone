...
```{r wctwtsample, echo=FALSE, warning=FALSE}
library(wordcloud)
...
For the purpose of this project, we look at up to fivegram MTDs and also have a backoff model. 
...
##Wordcloud
```{r wordcloudtdm, echo="FALSE", warning=FALSE}
...
##Histogram
The graphs below display top 30 terms for each of the TDMs.

```{r plotg1, fig.align='center'}
library(ggplot2)
