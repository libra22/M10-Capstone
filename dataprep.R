...
#save 1
save(allwordcount,file="allwordcount.RData")
save(blogwordcount,file="blogwordcount.RData")
save(newswordcount,file="newswordcount.RData")
save(twtwordcount,file="twtwordcount.RData")
save(datablog,file="datablog.RData")
save(datanews,file="datanews.RData")
save(datatwitter,file="datatwitter.RData")

load("datablog.RData")
load("datanews.RData")
load("datatwitter.RData")
...
save(sampleblog,file="sampleblog.RData")
save(samplenews,file="samplenews.RData")
save(sampletwt,file="sampletwt.RData")

load("sampletwt.RData")
load("sampleblog.RData")
load("samplenews.RData")
...
#save 4
save(allsample.corpus,file="allsamplecorpus.RData")
load("allsamplecorpus.RData")
load("plist.RData")
...
save(allsample.corpus,file="allsamplecorpuscleaned.RData")
...
save(tdm1a, file="tdm1a.RData")
save(tdm2a, file="tdm2a.RData")
...
save(tdm1df,file="tdm1df.RData")
save(tdm2df,file="tdm2df.RData")
save(tdm3df,file="tdm3df.RData")
save(tdm4df,file="tdm4df.RData")
save(tdm5df,file="tdm5df.RData")
